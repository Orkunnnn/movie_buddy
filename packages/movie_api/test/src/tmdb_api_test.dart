    ...
    () {
      ...
      setUp(
        () {
          ...
          movieApi = MovieApi(baseUrl: baseUrl, httpClient: httpClient);
      ...
      group(
        ...
        () {
          test(
            "does not require Movies",
            () {
              expect(
                MovieApi(baseUrl: baseUrl, httpClient: httpClient),
                isNotNull,
              );
            },
          );
            ...
            () {
              ...
              test(
                  ...
                  ).thenReturn('''
                {
                  ...
                  final actual = await movies.getDetails(2, "tr");
                  expect(
                    actual,
                    isA<RawMovieDetails>()
            ...
            () {
              ...
              test(
                ...
                ''');
                  ...
                  final actual = await movies.getPopular("tr");
                  expect(actual, [
                    isA<RawMoviePopular>()
